...
public class About extends JFrame implements ActionListener{
	...
	public About(){	
		ImageIcon background = new ImageIcon(getClass().getResource("about.jpg"));
        backlabel = new JLabel(background);
        backlabel.setBounds(0, 0, background.getIconWidth(),background.getIconHeight());		
	        
		about = new JFrame("¹ØÓÚ");
		about.setLocation(MainFrame.Locatewidth, MainFrame.Locateheight);
        about.setUndecorated(true);
        about.setSize(1120, 630);
